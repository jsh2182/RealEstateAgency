...
namespace RealEstateAgency
{
    public class clsAES
    {
                ...
                else // password is different size, so manually copy
                {
                    ...
                    for (i = 0; i < keyLen; i++)
                    {
                        ...
                        if (i < kbLen)
                            ...
                            // CHANGE BY Ahmad this.key[i] = nextByte++;
                            this.key[i] = 0;
                    }
                }
        ...
        public string Encrypt(string input)
        {
           ...
           // int i = 0, sLen = 0;
            ...
            try
            {
                 ...
                 */
                rText = Convert.ToBase64String(bText);
            }
           ...
           // int i = 0, sLen = 0;
            ...
            try
            {
                ...
                */
                ...
                rText = System.Text.Encoding.UTF8.GetString(Decrypt(bInput));
            }
        ...
        private byte[] ConvertStringToByteArray(string StrToConvert)
        {
            ...
            return System.Text.ASCIIEncoding.UTF8.GetBytes(StrToConvert);
        }
